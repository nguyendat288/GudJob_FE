...
import { Box, Container, AppBar, Toolbar, Typography, InputBase, Divider } from '@mui/material';
      ...
      <Box display='flex' m={5}>
        <Box flex='3.5'>
          <Box alignItems={'center'} justifyContent='center' >
            <Typography fontSize='30px' fontWeight='bold' mb={3}> {listBlog.title}</Typography>
            <Box display='flex' justifyContent='space-between'>
              <Typography> Tác giả : {listBlog.author} </Typography>
              <Typography> Ngày tạo : {formatDateTime(listBlog.createDate)}  </Typography>
            </Box>
            <Divider/>
            <Box mt ={5}>
        ...
        <Box flex='1' ml={3} p={3}>
          <Box>
          <Typography fontSize='20px' fontWeight='400'> Bài viết liên quan </Typography>
          </Box>
